...
# Part 2: How many tokens must you spend to get all possible prizes?
#         Now add 10000000000000 to every X and Y
...
foreach {lineA lineB lineC blank} $lines {
    ...
    # Change for part2:  Add 10000000000000 to both X and Y.
    incr X 10000000000000
    incr Y 10000000000000
